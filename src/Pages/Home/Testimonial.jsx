    ...
    <section className="my-8 dark:bg-gray-100 dark:text-gray-800">
      <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
        ...
        <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl dark:text-gray-700">
          I am always greatfull to them for servicing us as our need. Their
          effort captivates me alway.
        </p>
        <div className="flex justify-center space-x-3">
          <img
            src="https://lh3.googleusercontent.com/a/ACg8ocJmfnBp7jGxkapLyuZqo7l1qnCKKvpbAfijMTM5jza5QAYOfqg=s96-c"
            alt=""
            className="w-20 h-20 bg-center bg-cover rounded-md  dark:bg-gray-300"
          />
          <div>
            <p className="leading-tight">Shakib AL Hasan</p>
